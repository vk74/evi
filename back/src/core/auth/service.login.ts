...
import { AUTH_LOGIN_EVENTS, AUTH_SECURITY_EVENTS, AUTH_TOKEN_EVENTS, AUTH_SERVICE_EVENTS, AUTH_CONTROLLER_EVENTS } from './events.auth';
...
/**
 * Handle login request with business logic
 * Contains all validation, event creation, and request processing logic
 * @param req Express request object
 * @param res Express response object
 * @returns Promise resolving to login response
 */
export async function handleLoginRequest(req: Request, res: Response): Promise<LoginResponse> {
