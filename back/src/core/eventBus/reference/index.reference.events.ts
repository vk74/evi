...
export const eventReferenceFiles: Record<string, string[]> = {
  ...
  // Public policies events - events for public API operations (password policies, validation rules, public settings)
  publicPolicies: [
  ...
  system: [
    ...
    path.resolve(__dirname, '../../../modules/admin/settings/events.admin.regions.ts'),
    path.resolve(__dirname, '../../services/user-location-selection/events.user.location.selection.ts')
  ],
