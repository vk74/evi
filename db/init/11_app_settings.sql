...
-- Appearance Settings
('Application.Appearance', 'navbar.backgroundcolor', 'all', '"#F8F8F8"', '{"type":"string","pattern":"^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$"}', '"#F8F8F8"', 'Navigation bar background color (hex format)', true),
