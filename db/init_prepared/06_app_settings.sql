...
('Application.Security.SessionManagement', 'refresh.token.lifetime', 'all', '691200', 'Validity period of refresh access token issued to users devices', false),
...
('UsersManagement.GroupsManagement', 'add.only.active.users.to.groups', 'all', 'false', 'Allow adding to groups only those users with status ACTIVE', true)
