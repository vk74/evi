...
Changes in v1.12.0:
- Extracted taxable categories block into separate component PricingTaxCategories.vue
- Re-integrated PricingTaxCategories component below VAT regions block
- Removed all taxable categories related code, functions, and styles from PricingTax.vue
-->
