<!--
  File: Services.Settings.vue - frontend file
  Description: Services settings section component for Services management module
  Purpose: Configure catalog services-related settings and parameters from Services module
  Version: 1.0.0
...
const section_path = 'AdminServices';
...
async function loadSettings() {
  ...
  try {
    console.log('Loading settings for AdminServices');
...
onMounted(() => {
  console.log('Services Settings component initialized');
  loadSettings();
});
</script>
...
<template>
  <div class="catalog-services-container">
    <h2 class="text-h6 mb-4">
      {{ t('admin.services.settings.title') }}
    </h2>
        ...
        <div class="section-content">
          ...
          <div class="color-picker-container">
            <v-text-field
              ...
              :label="t('admin.services.settings.cardColor.label')"
              variant="outlined"
              density="comfortable"
              placeholder="#F5F5F5"
              :rules="[v => /^#[0-9A-Fa-f]{6}$/.test(v) || t('admin.services.settings.cardColor.picker.validHex')]"
              color="teal"
            ...
            >
              <v-card>
                <v-card-title class="text-subtitle-1">
                  {{ t('admin.services.settings.cardColor.picker.title') }}
                </v-card-title>
                <v-card-text>
                  <div class="color-picker-content">
                    ...
                    <div class="preset-colors mb-4">
                      <div class="preset-title mb-2">
                        {{ t('admin.services.settings.cardColor.picker.basicColors') }}
                      </div>
                    ...
                    <div class="custom-color-input">
                      <div class="input-title mb-2">
                        {{ t('admin.services.settings.cardColor.picker.customColor') }}
                      </div>
                      <v-text-field
                        v-model="selectedColor"
                        :label="t('admin.services.settings.cardColor.picker.hexCode')"
                        variant="outlined"
                        density="compact"
                        placeholder="#000000"
                        :rules="[v => /^#[0-9A-Fa-f]{6}$/.test(v) || t('admin.services.settings.cardColor.picker.validHex')]"
          ...
          >
            ...
            <div class="pa-2">
              <p class="text-subtitle-2 mb-2">
                {{ t('admin.services.settings.messages.error.tooltip.title') }}
              </p>
              <p class="text-caption">
                {{ t('admin.services.settings.messages.error.tooltip.retry') }}
              </p>
            </div>
          </v-tooltip>
        </div>
