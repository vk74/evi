<!--
  ...
  Version: 1.1.0
  Description: Wrapper component for section editor with navigation
  Purpose: Hosts app bar and renders SectionEditorData
  Frontend file - CatalogSectionEditor.vue
  
  Changes in v1.1.0:
  - Removed SectionEditorMapping component and "service mappings" tab
  - Service mapping functionality moved to ServicesPublisher component
-->
