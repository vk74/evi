...
onMounted(() => {
  console.log('Catalog.Products component initialized');
  loadSettings();
});
</script>
...
<template>
  <div class="catalog-products-container">
    <h2 class="text-h6 mb-4">
      {{ t('admin.settings.catalog.products.title') }}
    </h2>
        ...
        <div class="section-content">
          ...
          <div class="d-flex align-center mb-2">
            <v-switch
              ...
              color="teal-darken-2"
              :label="t('admin.settings.catalog.products.displayOptionsOnly.label')"
              hide-details
