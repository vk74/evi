    ...
    <template v-if="!isLoadingSettings">
      ...
      <div class="settings-section">
        <div class="section-content">
          ...
          <div
            class="levels-section mt-4"
            :class="{ 'opacity-50': !enabled }"
          >
            <p class="text-subtitle-2 mb-2">
              уровни логирования по типам операций
            </p>
            ...
            <v-row>
              ...
              >
                <div class="d-flex align-center mb-1">
                  <v-icon
                    :icon="operationTypesMetadata[key].icon"
                    size="small"
                    class="mr-1"
                  />
                  ...
                  <v-tooltip location="top">
                    ...
                    <div class="pa-2">
                      {{ operationTypesMetadata[key].description }}
                    </div>
                  </v-tooltip>
                </div>
                  ...
                  <template #item="{ item, props }">
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="pa-2">
                          {{ logLevelDescriptions[item.title] }}
                        </div>
                      </v-tooltip>
                    </v-list-item>
                  </template>
