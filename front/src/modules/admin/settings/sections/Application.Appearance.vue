...
const navbarColor = ref<string | null>(null);

// Color picker state
const showColorPicker = ref(false);
const selectedColor = ref('#26A69A');
...
const openColorPicker = () => {
  selectedColor.value = navbarColor.value || '#26A69A';
 ...
 */
const applyColor = () => {
  navbarColor.value = selectedColor.value;
      ...
      <div class="settings-section">
        <div class="section-content">
          ...
          <div class="color-picker-container">
            <v-text-field
              v-model="navbarColor"
              :label="t('admin.settings.application.appearance.navbarColor.label')"
              variant="outlined"
              density="comfortable"
              placeholder="#26A69A"
            ...
            >
              <template #prepend-inner>
                <div
                  class="color-preview"
                  :style="{ backgroundColor: navbarColor || '#26A69A' }"
            ...
            >
              <v-card>
                <v-card-title class="text-subtitle-1">
                  {{ t('admin.settings.application.appearance.navbarColor.picker.title') }}
                </v-card-title>
                <v-card-text>
                  <div class="color-picker-content">
                    ...
                    <div class="preset-colors mb-4">
                      <div class="preset-title mb-2">
                        {{ t('admin.settings.application.appearance.navbarColor.picker.basicColors') }}
                      </div>
                    ...
                    <div class="custom-color-input">
                      <div class="input-title mb-2">
                        {{ t('admin.settings.application.appearance.navbarColor.picker.customColor') }}
                      </div>
                      <v-text-field
                        v-model="selectedColor"
                        :label="t('admin.settings.application.appearance.navbarColor.picker.hexCode')"
                        variant="outlined"
                        density="compact"
                        placeholder="#000000"
                        :rules="[v => /^#[0-9A-Fa-f]{6}$/.test(v) || t('admin.settings.application.appearance.navbarColor.picker.validHex')]"
