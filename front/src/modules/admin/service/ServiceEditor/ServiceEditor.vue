...
<template>
  <v-container class="pa-0">
    ...
    <v-container class="content-container">
      ...
      >
        ...
        <v-card-text class="pt-3">
          ...
          <v-row>
            ...
            >
              <v-tooltip
                text="для отображения на плитке каталога в свернутом виде"
                location="top"
              >
                <template #activator="{ props }">
                  <v-textarea
          ...
          <v-row>
            <v-col cols="12">
              <v-tooltip
                text="для отображения на плитке каталога в развернутом виде"
                location="top"
              >
                <template #activator="{ props }">
                  <v-textarea
      ...
      <!-- Секция Визуализация -->
      <v-card
        v-if="activeSection === 'visualization'"
        flat
      >
        <div class="card-header">
          <v-card-title class="text-subtitle-1">
            отображение карточки сервиса в каталоге
          </v-card-title>
          <v-divider class="section-divider" />
        </div>
        <v-card-text class="pt-3">
          <v-row>
            <v-col cols="12">
              <div class="tile-section-label">
                плитка сервиса в закрытом состоянии
              </div>
            </v-col>
            <v-col cols="12">
              <div class="dimensions-group">
                <v-tooltip
                  text="ширина плитки в закрытом виде"
                  location="top"
                >
                  <template #activator="{ props }">
                    <v-text-field
                ...
                <v-tooltip
                  text="высота плитки в закрытом виде"
                  location="top"
                  class="ml-4"
                >
                  <template #activator="{ props }">
          ...
          <v-row>
            <v-col cols="12">
              <div class="tile-section-label">
                плитка сервиса в раскрытом состоянии
              </div>
            </v-col>
            <v-col cols="12">
              <div class="dimensions-group">
                <v-tooltip
                  text="ширина плитки в раскрытом виде"
                  location="top"
                >
                  <template #activator="{ props }">
                    <v-text-field
                ...
                <v-tooltip
                  text="высота плитки в раскрытом виде"
                  location="top"
                  class="ml-4"
                >
                  <template #activator="{ props }">
