<!--
  ...
  - Updated frontend library versions: Vue 3.5.28, Vuetify 3.11.8, Pinia 3.0.4, vue-i18n 11.2.8,
    axios 1.13.5, VueUse 14.2.1, TypeScript 5.9.3, pinia-plugin-persistedstate 4.7.1,
    jsonwebtoken 9.0.3, core-js 3.48.0
  - Backend: Express 5.2.1, removed body-parser, jsonwebtoken 9.0.3
...
const VERSION_FE = '0.11.8'
const VERSION_BE = '0.11.7'
const VERSION_DB = '0.11.7'
...
const componentsData = computed<ComponentsData>(() => ({
  ...
  frontend: {
    ...
    items: [
      ...
      { name: 'TypeScript 5.9.3 - typed javascript', url: 'https://www.typescriptlang.org' },
      { name: 'Pinia 3.0.4 - state management', url: 'https://pinia.vuejs.org' },
      { name: 'pinia-plugin-persistedstate 4.7.1 - pinia persistence', url: 'https://github.com/prazdevs/pinia-plugin-persistedstate' },
      { name: 'Vue I18n 11.2.8 - internationalization', url: 'https://vue-i18n.intlify.dev' },
      { name: 'Axios 1.13.5 - HTTP client', url: 'https://github.com/axios/axios' },
      { name: 'Phosphor Icons 2.2.1 - icon library', url: 'https://phosphoricons.com' },
      { name: 'VueUse 14.2.1 - vue composition utilities', url: 'https://vueuse.org' },
      { name: 'jwt-decode 4.0.0 - JWT token handling', url: 'https://github.com/auth0/jwt-decode' },
      { name: 'jsonwebtoken 9.0.3 - JWT library', url: 'https://github.com/auth0/node-jsonwebtoken' },
      { name: 'core-js 3.48.0 - javascript polyfills', url: 'https://github.com/zloirock/core-js' },
