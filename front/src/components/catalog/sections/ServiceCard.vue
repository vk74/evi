...
<template>
    ...
    >
      <!-- Компактный вид -->
      <div v-if="!expanded" class="d-flex align-center pa-4">
        <v-icon size="large" class="mr-4">{{ serviceIcon }}</v-icon>
      ...
      <v-expand-transition>
        <div v-if="expanded">
          <!-- Индикатор загрузки -->
          <div v-if="isLoadingDetails" class="d-flex justify-center pa-4">
          ...
          <div v-else>
            ...
            <v-card-item>
              <v-card-title class="text-h5 mb-2">{{ serviceName }}</v-card-title>
              <v-card-text>
                <div v-if="serviceDetails" class="text-body-1">
            ...
            <v-card-item>
              <v-card-title class="text-h6">Предлагаемые услуги</v-card-title>
              <v-card-text>
                <div v-if="serviceDetails && serviceDetails.service_options" class="text-body-2">
